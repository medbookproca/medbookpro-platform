...
MedBookPro is a Canadian-first, multi-tenant healthcare clinic operating system. This repository contains the application foundation, Supabase Auth boundary, organization onboarding, practitioner/availability foundations, patient foundation, appointment scheduling engine, and clinical foundation; it does not implement billing or production infrastructure.

## Status

Initial platform workspace with email/password Supabase Auth integration, cookie sessions, callback handling, organization/first-location onboarding, protected practitioner/availability routes, and protected patient identity routes. Hosted Supabase deployment remains intentionally excluded.
...
Read [local setup](docs/development/local-setup.md), [environment variables](docs/development/environment-variables.md), [testing](docs/development/testing.md), [launch readiness](docs/development/launch-readiness.md), [pilot configuration](docs/development/launch-readiness-configuration.md), [workspace structure](docs/architecture/workspace-structure.md), [staff invitations and memberships](docs/development/staff-invitations-memberships.md), [practitioner foundation](docs/development/practitioner-foundation.md), [practitioner availability engine](docs/development/practitioner-availability-engine.md), [patient foundation](docs/development/patient-foundation.md), [appointment scheduling engine](docs/development/appointment-scheduling-engine.md), [clinical foundation](docs/development/clinical-foundation.md), and the [Master Product Requirements Document](docs/product/medbookpro-master-prd.md) before contributing.
